 ...
 *
 * Customized by jareee, shows only one catecory "elamus" from custom post type "article"
 *
 ...
 */
class Tortuga_Pro_Magazine_Posts_List_Elamus_Widget extends WP_Widget {
	...
	function __construct() {
		...
		// Setup Widget.
		parent::__construct(
			'tortuga-magazine-posts-list-elamus', // ID.
			esc_html__( 'TPM List (Elamus)', 'tortuga-pro' ), // Name.
			array(
				'classname' => 'tortuga-magazine-list-elamus-widget',
				'description' => esc_html__( 'Category posts list - from cat "elamus".', 'tortuga-pro' ),
	...
	private function default_settings() {
		...
		$defaults = array(
			'title'    => esc_html__( 'TPM List (Elamus)', 'tortuga-pro' ),
			'category' => 0,
			'number'   => 3,
		);
	...
	function render( $settings ) {
		...
		$widget_category = 'elamus';
		$widget_issue_id = get_newest_issuem_issue_id();
		...
		$query_arguments = array(
			...
			*/
			...
			// custom article post-type arguments						
			'post_type'		=> 'article',
			'tax_query' => array(
				    'relation' => 'AND',
				array(
