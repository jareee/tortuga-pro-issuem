 ...
 */
class Tortuga_Pro_Magazine_Posts_List_Praktiline_Widget extends WP_Widget {
	...
	function __construct() {
		...
		// Setup Widget.
		parent::__construct(
			'tortuga-magazine-posts-list-praktiline', // ID.
			esc_html__( 'TPM List (Praktilist)', 'tortuga-pro' ), // Name.
			array(
				'classname' => 'tortuga-magazine-list-praktiline-widget',
				'description' => esc_html__( 'Category posts list - from cat "praktiline".', 'tortuga-pro' ),
	...
	private function default_settings() {
		...
		$defaults = array(
			'title'    => esc_html__( 'TPM List (Praktilist)', 'tortuga-pro' ),
			'category' => 0,
			'number'   => 3,
		);
