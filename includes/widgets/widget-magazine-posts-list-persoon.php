 ...
 */
class Tortuga_Pro_Magazine_Posts_List_Persoon_Widget extends WP_Widget {
	...
	function __construct() {
		...
		// Setup Widget.
		parent::__construct(
			'tortuga-magazine-posts-list-persoon', // ID.
			esc_html__( 'TPM List (Persoon)', 'tortuga-pro' ), // Name.
			array(
				'classname' => 'tortuga-magazine-list-persoon-widget',
				'description' => esc_html__( 'Category posts list - from cat "persoon".', 'tortuga-pro' ),
	...
	private function default_settings() {
		...
		$defaults = array(
			'title'    => esc_html__( 'TPM List (Persoon)', 'tortuga-pro' ),
			'category' => 0,
			'number'   => 3,
		);
