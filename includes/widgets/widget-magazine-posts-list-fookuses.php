 ...
 */
class Tortuga_Pro_Magazine_Posts_List_Fookuses_Widget extends WP_Widget {
	...
	function __construct() {
		...
		// Setup Widget.
		parent::__construct(
			'tortuga-magazine-posts-list-fookuses', // ID.
			esc_html__( 'TPM List (Fookuses)', 'tortuga-pro' ), // Name.
			array(
				'classname' => 'tortuga-magazine-list-fookuses-widget',
				'description' => esc_html__( 'Category posts list - from cat "fookus".', 'tortuga-pro' ),
	...
	private function default_settings() {
		...
		$defaults = array(
			'title'    => esc_html__( 'TPM List (Fookuses)', 'tortuga-pro' ),
			'category' => 0,
			'number'   => 3,
		);
